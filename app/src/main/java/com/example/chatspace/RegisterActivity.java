...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void CreateNewAccount() {
        ...
        if(TextUtils.isEmpty(email)){
            ...
            loadingBar.setMessage("Be patient, we are creating new account");
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(RegisterActivity.this, "Congrats! Created Successfully", Toast.LENGTH_SHORT).show();
                            }else{
                                // Sign up fails
                                String message = task.getException().toString();
                                Toast.makeText(RegisterActivity.this, "Ups, Error!: " + message, Toast.LENGTH_SHORT).show();
                            }
                            loadingBar.dismiss();
                        }
                    });
